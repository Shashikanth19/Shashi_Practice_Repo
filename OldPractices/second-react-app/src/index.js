...
import ComponentStyles from './App';
let root = reactDOM.createRoot(document.getElementById('root'))
...
/*Props
import FragmentsExample from './App';
let root = reactDOM.createRoot(document.getElementById('root'))
...
/*Props for functions
import ExampleForProps from './App';
let root = reactDOM.createRoot(document.getElementById('root'))

root.render(
  <ExampleForProps name='shashikanth' age='24'/>
)*/
/*Props for class components*/
import PropsExampleForClassComponents from './App';
let root = reactDOM.createRoot(document.getElementById('root'))

root.render(
  <PropsExampleForClassComponents name='shashikanth' age='23'/>
)